...
class GUI:
    def __init__(self, name):
        self.name = name
        self.layout = self.get_window_layout()
        self.size = self.get_window_size()
        self.element_justification = self.get_element_justification()
        self.window = self.get_window()
        return

    def get_window(self):
        return sg.Window(f'{self.name}', self.get_layout(), size = self.size, element_justification = self.element_justification)
    ...
    def get_window_layout(self, buttons = []):
        columns = []
        for i in buttons:
            column = []
            for e in i:
    ...
    def get_element_justification(self):
        pass
